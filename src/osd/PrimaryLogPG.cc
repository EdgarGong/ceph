 ...
 */
class PrimaryLogPG::CopyCallback :
public GenContext<CopyCallbackResults> {
protected:
CopyCallback() {
}
/**
...
template <typename T>
class PrimaryLogPG::BlessedGenContext :
public GenContext<T> {
PrimaryLogPGRef pg;
...
template <typename T>
class PrimaryLogPG::UnlockedBlessedGenContext :
public GenContext<T> {
PrimaryLogPGRef pg;
unique_ptr<GenContext<T>> c;
epoch_t e;
...
class PrimaryLogPG::BlessedContext :
public Context {
PrimaryLogPGRef pg;
...
class PrimaryLogPG::C_PG_ObjectContext :
public Context {
PrimaryLogPGRef pg;
ObjectContext *obc;
public:
...
class PrimaryLogPG::C_OSD_AppliedRecoveredObject :
public Context {
PrimaryLogPGRef pg;
...
class PrimaryLogPG::C_OSD_CommittedPushedObject :
public Context {
PrimaryLogPGRef pg;
epoch_t epoch;
...
class PrimaryLogPG::C_OSD_AppliedRecoveredObjectReplica :
public Context {
PrimaryLogPGRef pg;
public:
...
struct C_SetManifestRefCountDone :
public Context {
PrimaryLogPGRef pg;
hobject_t soid;
uint64_t offset;
...
[&](snapid_t snap_id) {
return snap_id > ctx->new_snapset.seq; });
...
rep_tid,
LogUpdateCtx{
std::move(repop), std::move(waiting_on)
}
));
struct OnComplete :
public Context {
...
dout_prefix
#define
dout_prefix pg->gen_prefix(*_dout)
...
dout_prefix
#define
dout_prefix (context< SnapTrimmer >().pg->gen_prefix(*_dout) \
